...
category: "Right Heart",
    ...
    tapsen: {
        audience: ["vet"], title: "TAPSEn (Tricuspid Annular Plane Systolic Excursion - Normalised)",
        view: "Left Apical 4-Chamber (RV Optimized)",
        description: "Assesses longitudinal right ventricular systolic function - normalised for body weight.",
        group: "echo", method: "Measure TAPSE as the vertical displacement of the tricuspid valve annulus, then normalised to body weight. Calculated as: (TAPSE in mm) / (Body Weight in kg)^0.285. A value < 4.5 is a primary criteria for right ventricular systolic dysfunction",
...
category: "Right Heart",
    ...
    rvwt: {
        audience: ["vet"], title: "RVWT (Right Ventricular Wall Thickness)",
        ...
        group: "echo", method: "Measure the free wall thickness at end-diastole using 2D or M-mode, avoiding papillary muscles and trabeculae.",
        imgPlaceholder: "/images/rvwt-reference.jpg",
category: "Right Heart",
        difficulty: 2
    },
    rveda: {
        audience: ["vet"], title: "RVEDA (RV End-Diastolic Area)",
        view: "Left Apical 4-Chamber (RV Optimized)",
        description: "Quantifies global right ventricular dilation.",
        group: "echo", method: "Trace the endocardial border of the RV at end-diastole (maximum volume). Exclude the trabeculae and papillary muscles from the trace line. Close the trace flat across the tricuspid annulus.",
        imgPlaceholder: "/images/rveda-reference.jpg",
category: "Right Heart",
        difficulty: 3
    },
    rvesan: {
        audience: ["vet"], title: "RVESAn (RV End-Systolic Area - Normalised)",
        view: "Left Apical 4-Chamber (RV Optimized)",
        description: "Quantifies RV systolic failure and volume retention - normalised for body weight.",
        group: "echo", method: "Trace the endocardial border at end-systole (minimum volume), then normalised to body weight. Calculated as: (RVESA in cm2) / (Body Weight in kg)^0.695. A value > 0.8 is a primary criteria for right ventricular systolic dysfunction",
        reference: "Feldhütter et al. Echocardiographic reference intervals for right ventricular indices, including 3‐dimensional volume and 2‐dimensional strain measurements in healthy dogs",
        pmid: "34874066",
category: "Right Heart",
        difficulty: 3
    ...
    rvedan: {
        audience: ["vet"], title: "RVEDAn (RV End-Diastolic Area - Normalised)",
        view: "Left Apical 4-Chamber (RV Optimized)",
        description: "Quantifies global right ventricular dilation - normalised for body weight.",
        group: "echo", method: "Trace the endocardial border at end-systole (minimum volume), then normalised to body weight. Calculated as: (RVEDA in cm2) / (Body Weight in kg)^0.665. A value > 1.4 is a primary criteria for right ventricular dilation",
        reference: "Feldhütter et al. Echocardiographic reference intervals for right ventricular indices, including 3‐dimensional volume and 2‐dimensional strain measurements in healthy dogs",
        pmid: "34874066",
category: "Right Heart",
        difficulty: 3
    ...
    rvesa: {
        audience: ["vet"], title: "RVESA (RV End-Systolic Area)",
        view: "Left Apical 4-Chamber (RV Optimized)",
        description: "Quantifies RV systolic failure and volume retention.",
        group: "echo", method: "Trace the endocardial border at end-systole (minimum volume), following the same exclusion rules as RVEDA.",
        imgPlaceholder: "/images/rvesa-reference.jpg",
category: "Right Heart",
        difficulty: 3
    },
    rvd1: {
        audience: ["vet"], title: "RVD1 (Basal RV Diameter)",
        view: "Left Apical 4-Chamber (RV Optimized)",
        description: "Assesses basal segment right ventricular dilation.",
        group: "echo", method: "Measure the maximal transverse diameter of the RV basal third at end-diastole, typically just above the level of the tricuspid valve leaflets.",
        imgPlaceholder: "/images/rvd1-reference.jpg",
category: "Right Heart",
        difficulty: 3
    },
    rad: {
        audience: ["vet"], title: "RAD (Right Atrial Diameter - Apical 4 Chamber View)",
        ...
        group: "echo", method: "Measure the maximal right atrial major dimension (base to apex) at end-systole (when the atrium is maximally full), parallel to the interatrial septum.",
        imgPlaceholder: "/images/rad-reference.jpg",
category: "Right Heart",
        difficulty: 3
    },
    rad2: {
        audience: ["vet"], title: "RAD RPLA (Right Atrial Diameter - Right Parasternal Long Axis view)",
...
// --- INTERNAL SCALAR INDICES (SANKISOV 2024) ---
    tapseaola: {
        audience: ["vet"], title: "TAPSE:Ao Ratio",
        view: "Derived Index",
        ...
        group: "echo", method: "Calculated as: TAPSE / Aorta.",
...
category: "Right Heart",
    ...
    radaola: {
        audience: ["vet"], title: "RAD:Ao Ratio (RA Major Axis)",
        view: "Derived Index",
        ...
        group: "echo", method: "Calculated as: RAD / Aorta.",
        reference: "Sankisov et al. Echocardiographic reference intervals for right heart indices normalized to aortic diameter in healthy dogs.",
        pmid: "39350563",
category: "Right Heart",
        difficulty: 3
    ...
    rad2aola: {
        audience: ["vet"], title: "RAD2:Ao Ratio (RA RPLA Axis)",
        view: "Derived Index",
        ...
        group: "echo", method: "Calculated as: RAD2  / Aorta.",
        reference: "Sankisov et al. Echocardiographic reference intervals for right heart indices normalized to aortic diameter in healthy dogs.",
        pmid: "39350563",
category: "Right Heart",
        difficulty: 3
    ...
    rad2lad: {
        audience: ["vet"], title: "RAD2:LAD Ratio (Right to Left Atrial Ratio)",
        view: "Derived Index",
        ...
        group: "echo", method: "Calculated as: RAD2 (RA RPLA) / LAD (LA Dimension).",
        reference: "Sankisov et al. Echocardiographic reference intervals for right heart indices normalized to aortic diameter in healthy dogs.",
        pmid: "39350563",
category: "Right Heart",
        difficulty: 3
    ...
    rvd1aola: {
        audience: ["vet"], title: "RVD1:Ao Ratio (RV Basal Diameter)",
        view: "Derived Index",
        ...
        group: "echo", method: "Calculated as: RVD1 / Aorta.",
        reference: "Sankisov et al. Echocardiographic reference intervals for right heart indices normalized to aortic diameter in healthy dogs.",
        pmid: "39350563",
category: "Right Heart",
        difficulty: 3
    ...
    rvwtaola: {
        audience: ["vet"], title: "RVWT:Ao Ratio",
        view: "Derived Index",
        ...
        group: "echo", method: "Calculated as: RVWT / Aorta.",
        reference: "Sankisov et al. Echocardiographic reference intervals for right heart indices normalized to aortic diameter in healthy dogs.",
        pmid: "39350563",
category: "Right Heart",
        difficulty: 3
    ...
    rvwtlvpwd: {
        audience: ["vet"], title: "RVWT:LVPWd Ratio (Wall Thickness Ratio)",
        view: "Derived Index",
        ...
        group: "echo", method: "Calculated as: RVWT / LVPWd.",
        reference: "Sankisov et al. Echocardiographic reference intervals for right heart indices normalized to aortic diameter in healthy dogs.",
        pmid: "39350563",
category: "Right Heart",
        difficulty: 3
    ...
    paaola: {
        audience: ["vet"], title: "PA:Ao Ratio (Pulmonary Artery to Aorta)",
        view: "Derived Index",
        ...
        group: "echo", method: "Calculated as: RVOTd (PA) / Aorta.",
        reference: "Sankisov et al. Echocardiographic reference intervals for right heart indices normalized to aortic diameter in healthy dogs.",
        pmid: "39350563",
category: "Right Heart",
        difficulty: 3
    ...
    lvidd2: {
        audience: ["vet"], title: "LVIDd₂ (Perpendicular Eccentricity)",
        ...
        group: "echo", method: "Measure the LV internal diameter at end-diastole perpendicular to the normal vertical LVIDd. If the septum is flattened by RV pressure, this horizontal measurement will be significantly larger than the vertical one.",
        imgPlaceholder: "/images/lvidd2-reference.jpg",
category: "Right Heart",
        difficulty: 3
    },
radn: {
        audience: ["vet"], title: "RADn (Normalized Right Atrial Diameter)",
        ...
        group: "echo", method: "Calculated as: (RAD in cm) / (Body Weight in kg)^0.4. Clinical limits suggest normal values remain < 0.90.",
category: "Right Heart",
        difficulty: 3
    },
    rvd1n: {
        audience: ["vet"], title: "RVD1n (Normalized RV Basal Diameter)",
        view: "Derived Index (Allometric Scaling)",
        ...
        group: "echo", method: "Calculated as: (RVD1 in cm) / (Body Weight in kg)^0.33. Clinical limits suggest normal values remain < 0.94.",
category: "Right Heart",
        difficulty: 3
    },
// --- LEFT HEART STRUCTURAL ---
    lvidd: {
        audience: ["vet"], title: "LVIDd (LV Internal Diameter - Diastole)",
        view: "Right Parasternal Short Axis (Papillary Level)",
        ...
        group: "echo", method: "Measure the maximal internal diameter of the left ventricle at end-diastole (peak R wave). Ensure the cursor is perpendicular to the septum and free wall.",
        imgPlaceholder: "/images/lvidd-reference.jpg",
category: "Left Heart",
        difficulty: 1
    },
    lvids: {
        audience: ["vet"], title: "LVIDs (LV Internal Diameter - Systole)",
        view: "Right Parasternal Short Axis (Papillary Level)",
        description: "Assesses left ventricular systolic function and contractility.",
        group: "echo", method: "Measure the minimal internal diameter of the left ventricle at peak systole (end of the T wave or maximal septal deviation).",
        imgPlaceholder: "/images/lvids-reference.jpg",
category: "Left Heart",
        difficulty: 1
    },
lviddn: {
        audience: ["vet"], title: "LVIDdn (Normalized LVID Diastole)",
        view: "Derived Index (Allometric Scaling)",
        ...
        group: "echo", method: "Calculated as: (LVIDd in cm) / (Body Weight in kg)^0.294. A value > 1.70 is a primary criteria for ACVIM Stage B2 MMVD.",
...
category: "Left Heart",
    ...
    lvidsn: {
        audience: ["vet"], title: "LVIDsn (Normalized LVID Systole)",
        view: "Derived Index (Allometric Scaling)",
        ...
        group: "echo", method: "Calculated as: (LVIDs in cm) / (Body Weight in kg)^0.315. Normal range is typically 0.71 to 1.26.",
category: "Left Heart",
        difficulty: 2
    },
    lan: {
        audience: ["vet"], title: "LAn (Normalized LA Short Axis)",
        view: "Derived Index (Allometric Scaling)",
        ...
        group: "echo", method: "Calculated as: (LA in cm) / (Body Weight in kg)^0.355.",
category: "Left Heart",
        difficulty: 2
    },
    ladn: {
        audience: ["vet"], title: "LADn (Normalized LA Long Axis)",
        view: "Derived Index (Allometric Scaling)",
        ...
        group: "echo", method: "Calculated as: (LAD in cm) / (Body Weight in kg)^0.309.",
...
category: "Left Heart",
    ...
    ladao: {
        audience: ["vet"], title: "LAD:Ao Ratio (Long Axis to Aorta)",
        view: "Derived Index",
...
category: "Left Heart",
    ...
    RWT: { // Capitalized to match your exact state getter
        ...
        group: "echo", method: "Calculated as: (2 × LV Posterior Wall) / LVIDd.",
category: "Left Heart",
        difficulty: 2
    },
...
category: "Left Heart",
  ...
  edvwess: {
    ...
    edvim2: {
        ...
        group: "echo", method: "Calculated as: LVEDV (ml) / BSA (m²). BSA is derived using standard canine conversion constants.",
category: "Left Heart",
        difficulty: 3
    },
    esvim2: {
        audience: ["vet"], title: "ESVI (End-Systolic Volume Index - BSA)",
        view: "Derived Index",
        ...
        group: "echo", method: "Calculated as: LVESV (ml) / BSA (m²).",
category: "Left Heart",
        difficulty: 3
    },
    la: {
        audience: ["vet"], title: "LA (Left Atrium Dimension)",
        ...
        group: "echo", method: "Measure the internal diameter of the LA at end-systole (when maximally filled), extending from the center of the aortic valve commissure to the dorsal LA wall.",
        imgPlaceholder: "/images/la-reference.jpg",
category: "Left Heart",
        difficulty: 1
    },
    lad: {
        audience: ["vet"], title: "LA diameter - long axis (Left Atrium Dimension)",
        view: "Right Parasternal Long Axis (4 chamber)",
        description: "Evaluates left atrial enlargement, the primary structural indicator of elevated left-sided filling pressures.",
        group: "echo", method: "Measure the internal diameter of the LA at end-systole (when maximally filled, the frame just before mitral valve opening), at the widest point, extending from the center of the interatrial septum to the inner wall of the posterior free wall, parallel to the mitral valve annulus.",
...
category: "Left Heart",
    ...
    ao: {
        audience: ["vet"], title: "Ao (Aortic Root Dimension)",
        view: "Right Parasternal Short Axis (Heart Base)",
        description: "Serves as a patient-specific internal baseline to normalize left atrial size.",
        group: "echo", method: "Measure the internal diameter of the aortic root at end-diastole (when closed), along the commissure of the non-coronary and right coronary cusps.",
        imgPlaceholder: "/images/ao-reference.jpg",
category: "Left Heart",
        difficulty: 1
    },
    aola: {
        audience: ["vet"], title: "Ao (Aortic Root Dimension) - Long Axis",
...
category: "Left Heart",
    ...
    ivsd: {
        ...
        group: "echo", method: "Measure the thickness of the septum at end-diastole, excluding the right ventricular trabeculae.",
...
category: "Left Heart",
    ...
    // --- LEFT HEART DOPPLER ---
    eVel: {
        audience: ["vet"], title: "Transmitral E-Wave Velocity",
        ...
        group: "echo", method: "Place the Pulsed Wave (PW) Doppler sample volume exactly at the tips of the open mitral valve leaflets during diastole.",
        imgPlaceholder: "/images/ewave-reference.jpg",
category: "Doppler",
        difficulty: 3
    },
    aVel: {
        audience: ["vet"], title: "Transmitral A-Wave Velocity",
        view: "Left Apical 4-Chamber",
        description: "Represents late, active diastolic filling driven by atrial contraction (the 'atrial kick').",
        group: "echo", method: "Measured from the same PW Doppler trace as the E-wave. Occurs immediately following the P-wave on the concurrent ECG.",
...
category: "Doppler",
    ...
    // --- CALCULATED INDICES ---
    fs: {
        audience: ["vet"], title: "Fractional Shortening (FS%)",
        view: "Derived Index",
        ...
        group: "echo", method: "Calculated automatically as: ((LVIDd - LVIDs) / LVIDd) × 100. Note: FS% can be falsely elevated in severe mitral regurgitation due to the low-resistance left atrium.",
category: "Left Heart",
        difficulty: 1
    },
    laAo: {
        audience: ["vet"], title: "LA:Ao Ratio",
        view: "Derived Index",
        ...
        group: "echo", method: "Calculated automatically by dividing the LA dimension by the Ao dimension measured at the heart base.",
        imgPlaceholder: "/images/laao-reference.jpg",
category: "Left Heart",
        difficulty: 1
    },
    ear: {
        audience: ["vet"], title: "E:A Ratio",
        view: "Derived Index",
        description: "The primary initial assessment for diastolic function and left atrial pressure.",
        group: "echo", method: "Normal physiologic filling results in an E > A pattern (Ratio > 1.0). An E:A ratio < 1.0 indicates impaired relaxation (Grade 1), while a ratio > 2.0 suggests restrictive filling (Grade 3).",
...
// --- LEFT HEART VOLUMES & WALLS ---
    lvpwd: {
        audience: ["vet"], title: "LVPWd (LV Posterior/Free Wall - Diastole)",
        ...
        group: "echo", method: "Measure the thickness of the LV free wall at end-diastole, placing calipers from the endocardial border to the epicardial border. Exclude papillary muscles.",
        imgPlaceholder: "/images/lvpwd-reference.jpg",
category: "Left Heart",
        difficulty: 1
    },
    lvedv: {
        audience: ["vet"], title: "LVEDV (LV End-Diastolic Volume)",
        ...
        group: "echo", method: "Typically calculated using the Simpson's Method of Discs (SMOD) or Area-Length method by tracing the endocardial border at maximum diastole.",
        imgPlaceholder: "/images/lvedv-reference.jpg",
category: "Left Heart",
        difficulty: 3
    },
    lvesv: {
        audience: ["vet"], title: "LVESV (LV End-Systolic Volume)",
        view: "Right Parasternal Long Axis / Apical 4-Chamber",
        description: "Quantifies the minimal systolic blood volume. Elevated volumes indicate myocardial systolic failure.",
        group: "echo", method: "Trace the endocardial border at maximum systole (minimum chamber size).",
...
category: "Left Heart",
    ...
    lvotd: {
        audience: ["vet"], title: "LVOTd (LV Outflow Tract Diameter)",
        view: "Right Parasternal Long Axis (5-Chamber)",
        description: "Crucial for calculating forward systemic stroke volume (Qs) and evaluating left-to-right shunts.",
        group: "echo", method: "Measure the internal diameter of the left ventricular outflow tract in mid-systole, positioned just below the aortic valve insertion points. Very similar measurement to Aortic valve (long axis) measurement.",
        imgPlaceholder: "/images/lvotd-reference.jpg",
category: "Left Heart",
        difficulty: 3
    },
    rvotd: {
        audience: ["vet"], title: "RVOTd (RV Outflow Tract Diameter)",
        view: "Right Parasternal Short Axis (Heart Base)",
        description: "Used alongside LVOTd to calculate Qp:Qs shunt ratios (e.g., PDA, VSD).",
        group: "echo", method: "Measure the internal diameter of the RVOT just proximal to the pulmonic valve annulus during mid-systole.",
        imgPlaceholder: "/images/rvotd-reference.jpg",
category: "Right Heart",
        difficulty: 3
    },
    lvotvti: {
        audience: ["vet"], title: "LVOT VTI (Velocity-Time Integral)",
        ...
        group: "echo", method: "Trace the envelope of the Pulsed Wave (PW) Doppler spectral signal obtained from the center of the LVOT.",
        imgPlaceholder: "/images/lvotvti-reference.jpg",
category: "Left Heart",
        difficulty: 3
    },
    rvotvti: {
        audience: ["vet"], title: "RVOT VTI (Velocity-Time Integral)",
        view: "Right Parasternal Short Axis (Heart Base)",
        description: "Represents the stroke distance of blood ejected into the pulmonary circulation.",
        group: "echo", method: "Trace the envelope of the PW Doppler signal obtained from the center of the RVOT, just proximal to the pulmonic valve.",
        imgPlaceholder: "/images/rvotvti-reference.jpg",
category: "Right Heart",
        difficulty: 3
    },
    ePrime: {
        audience: ["vet"], title: "e' (Mitral Annular Early Diastolic Velocity)",
        view: "Left Apical 4-Chamber",
        description: "A Tissue Doppler Imaging (TDI) metric representing true myocardial active relaxation.",
        group: "echo", method: "Place the TDI sample volume over the lateral mitral annulus. Measure the peak of the first negative (moving away) diastolic wave.",
...
category: "Doppler",
    ...
    mdt: {
        audience: ["vet"], title: "MDT (Mitral Deceleration Time)",
        view: "Left Apical 4-Chamber",
        ...
        group: "echo", method: "Measure the time interval from the peak of the transmitral E-wave down the deceleration slope to the baseline (0 m/s).",
        imgPlaceholder: "/images/mdt-reference.jpg",
category: "Doppler",
        difficulty: 3
    },
    ivrt: {
        audience: ["vet"], title: "IVRT (Isovolumic Relaxation Time)",
        ...
        group: "echo", method: "Place PW Doppler between the LVOT and Mitral inflow to capture both. Measure the time from aortic valve closure (end of ejection) to mitral valve opening (start of E-wave).",
        imgPlaceholder: "/images/ivrt-reference.jpg",
category: "Doppler",
        difficulty: 3
    },
    trMax: {
        audience: ["vet"], title: "TR Vmax (Tricuspid Regurgitation Peak Velocity)",
        ...
        group: "echo", method: "Align a Continuous Wave (CW) Doppler beam parallel to the TR jet. Measure the maximum peak velocity of the spectral envelope.",
        imgPlaceholder: "/images/trmax-reference.jpg",
category: "Doppler",
        difficulty: 3
    },
    prMax: {
        audience: ["vet"], title: "PR Vmax (Pulmonic Regurgitation Peak Velocity)",
        view: "Right Parasternal Short Axis",
        description: "Used to estimate diastolic pulmonary artery pressures.",
        group: "echo", method: "Align CW Doppler with the diastolic regurgitant jet across the pulmonic valve. Measure the peak early diastolic velocity.",
        imgPlaceholder: "/images/prmax-reference.jpg",
category: "Doppler",
        difficulty: 3
    },
    aovmax: {
        audience: ["vet"], title: "Ao Vmax (Aortic Peak Velocity)",
        ...
        group: "echo", method: "Use CW Doppler aligned with the aortic outflow. Measure the peak systolic velocity.",
        imgPlaceholder: "/images/aovmax-reference.jpg",
category: "Doppler",
        difficulty: 3
    },
    pavmax: {
        audience: ["vet"], title: "PA Vmax (Pulmonic Peak Velocity)",
        view: "Right Parasternal Short Axis",
        description: "Evaluates right ventricular outflow tract obstruction (e.g., Pulmonic Stenosis).",
        group: "echo", method: "Use CW Doppler aligned with the pulmonic outflow. Measure the peak systolic velocity.",
...
category: "Doppler",
    ...
    mpamin: {
        audience: ["vet"], title: "MPA min (Main Pulmonary Artery Minimum)",
        view: "Right Parasternal Short Axis (Heart Base)",
        description: "Used to assess pulmonary artery dilation, a hallmark of precapillary pulmonary hypertension.",
        group: "echo", method: "Measure the minimal internal diameter of the main pulmonary artery at end-diastole (just before pulmonic valve opening).",
...
category: "Right Heart",
    ...
    mpaAo: {
        audience: ["vet"], title: "MPA : Ao index (Main Pulmonary Artery to Aorta Sax Index)",
        view: "Right Parasternal Short Axis (Heart Base)",
        description: "Used to assess pulmonary artery dilation, a hallmark of precapillary pulmonary hypertension.",
        group: "echo", method: "Measure the minimal internal diameter of the main pulmonary artery at end-diastole (just before pulmonic valve opening). Index to the aortic valve in short axis. Calculated as MPAmin / Ao. A value under 1.01 is considered normal.",
        reference: "Grosso et al (2023). Echocardiographic reference intervals of the dimensions of the main pulmonary artery and the right pulmonary artery: a prospective study in 269 healthy dogs.",
        pmid: "37918089",
category: "Right Heart",
        difficulty: 3
    ...
    rpaminao: {
        audience: ["vet"], title: "RPAmin : Ao index (Right Pulmonary Artery minimum to Aorta Sax Index)",
        view: "Right Parasternal Short Axis (Heart Base), using M-mode through the RPA",
        description: "Used to assess pulmonary artery dilation, a hallmark of precapillary pulmonary hypertension.",
        group: "echo", method: "Measure the minimal internal diameter of the right pulmonary artery at end-diastole (just before pulmonic valve opening). Index to the aortic valve in short axis. Calculated as RPAmin / Ao. A value under 0.61 is considered normal.",
        reference: "Grosso et al (2023). Echocardiographic reference intervals of the dimensions of the main pulmonary artery and the right pulmonary artery: a prospective study in 269 healthy dogs.",
        pmid: "37918089",
category: "Right Heart",
        difficulty: 3
    ...
    rpamaxao: {
        audience: ["vet"], title: "MPA : Ao index (Right Pulmonary Artery maximum to Aorta Sax Index)",
        view: "Right Parasternal Short Axis (Heart Base), using M-mode through the RPA",
        description: "Used to assess pulmonary artery dilation, a hallmark of precapillary pulmonary hypertension.",
        group: "echo", method: "Measure the maximum internal diameter of the right pulmonary artery at end-diastole (just before pulmonic valve opening). Index to the aortic valve in short axis. Calculated as RPAmax / Ao. A value under 0.98 is considered normal.",
        reference: "Grosso et al (2023). Echocardiographic reference intervals of the dimensions of the main pulmonary artery and the right pulmonary artery: a prospective study in 269 healthy dogs.",
        pmid: "37918089",
...
category: "Right Heart",
    ...
    rpamin: {
        audience: ["vet"], title: "RPA min (Right Pulmonary Artery Minimum)",
        ...
        group: "echo", method: "Measure the internal diameter of the right pulmonary artery branch at end-diastole.",
...
category: "Right Heart",
    ...
    rpamax: {
        audience: ["vet"], title: "RPA max (Right Pulmonary Artery Maximum)",
        view: "Right Parasternal Short Axis, using M-mode through the RPA",
        description: "Evaluates the maximum distension of the RPA during peak systole.",
        group: "echo", method: "Measure the maximal internal diameter of the right pulmonary artery branch during peak systole.",
        imgPlaceholder: "/images/reference-rpa.jpg",
        reference: "Grosso et al (2023). Echocardiographic reference intervals of the dimensions of the main pulmonary artery and the right pulmonary artery: a prospective study in 269 healthy dogs.",
        pmid: "37918089",
imgAttribution: "CC-BY 4.0",
category: "Right Heart",
    ...
    rpadi: {
        audience: ["vet"], title: "RPAD index",
        view: "Derived Index",
        description: "The percentage change in diameter of the right pulmonary artery throughout a singe cardiac cycle.",
        group: "echo", method: "Calculated as: RPAD index = [(RPAmax  RPAmin) / RPAmax] x 100. A value over 31.2% is considered normal.",
        reference: "Grosso et al (2023). Echocardiographic reference intervals of the dimensions of the main pulmonary artery and the right pulmonary artery: a prospective study in 269 healthy dogs.",
        pmid: "37918089",
category: "Right Heart",
        difficulty: 3
    ...
    sv: {
        audience: ["vet"], title: "Stroke Volume (SV)",
        view: "Derived Index",
        description: "The total volume of blood ejected by the ventricle per beat.",
        group: "echo", method: "Calculated automatically by subtracting End-Systolic Volume (ESV) from End-Diastolic Volume (EDV).",
category: "Haemodynamics",
        difficulty: 3
    },
    ef: {
        audience: ["vet"], title: "Ejection Fraction (EF%)",
        view: "Derived Index",
        description: "The percentage of diastolic volume ejected per beat. A key indicator of systolic function.",
        group: "echo", method: "Calculated as: (Stroke Volume / LVEDV) × 100.",
category: "Left Heart",
        difficulty: 3
    },
    rwt: {
...
category: "Left Heart",
    ...
    eivrt: {
        audience: ["vet"], title: "E:IVRT Ratio",
        view: "Derived Index",
        ...
        group: "echo", method: "Calculated as: (E-wave velocity × 100) / IVRT. Ratios > 2.5 strongly correlate with elevated Left Atrial Pressure.",
category: "Doppler",
        difficulty: 3
    },
    lveio: {
        audience: ["vet"], title: "LVEIO (E:LVOT VTI)",
        view: "Derived Index",
        ...
        group: "echo", method: "Calculated as: E-wave velocity / LVOT VTI.",
category: "Doppler",
        difficulty: 3
    },
    eePrime: {
        audience: ["vet"], title: "E:e' Ratio",
        view: "Derived Index",
        description: "The gold-standard non-invasive surrogate for left atrial filling pressure.",
        group: "echo", method: "Calculated as: Transmitral E-wave velocity / TDI e' velocity. Normalizes blood flow against muscle relaxation speed.",
category: "Doppler",
        difficulty: 3
    },
    eplar: {
        audience: ["vet"], title: "ePLAR (Echocardiographic Pulmonary to Left Atrial Ratio)",
        view: "Derived Index",
        description: "Differentiates pre-capillary from post-capillary pulmonary hypertension.",
        group: "echo", method: "Calculated as: TR Vmax / E:e' Ratio. A high value (>0.28) points to primary lung vascular disease; a low value (<0.23) points to left heart failure backing up into the lungs.",
category: "Doppler",
        difficulty: 4
    },
    vtir: {
        audience: ["vet"], title: "VTI Ratio (P:S / Qp:Qs)",
        view: "Derived Index",
        ...
        group: "echo", method: "Calculated as: RVOT VTI / LVOT VTI (or cross-sectional areas for true volumetric Qp:Qs). Normal is roughly 1.0.",
category: "Doppler",
        difficulty: 4
    },
    rfac: {
        audience: ["vet"], title: "RV FAC% (Right Ventricular Fractional Area Change)",
        view: "Derived Index",
        ...
        group: "echo", method: "Calculated as: ((RVEDA - RVESA) / RVEDA) × 100.",
category: "Right Heart",
        difficulty: 3
    },
    trPG: {
        audience: ["vet"], title: "Pressure Gradient (TR PG)",
        view: "Derived Index",
        description: "Estimates the pressure difference between the right ventricle and right atrium during systole.",
        group: "echo", method: "Calculated using the modified Bernoulli equation: 4 × (Velocity²). When added to estimated Right Atrial Pressure (RAP), it yields Right Ventricular Systolic Pressure (RVSP).",
        imgPlaceholder: "/images/bernoulli-reference.jpg",
category: "Doppler",
        difficulty: 2
    },
    mrFraction: {
        audience: ["vet"], title: "Regurgitant Fraction (MR%)",
        view: "Derived Index",
        ...
        group: "echo", method: "Calculated as: (Mitral Regurgitant Volume / Total LV Stroke Volume) × 100.",
category: "Left Heart",
        difficulty: 4
    },
    lvei: {
        audience: ["vet"], title: "LVEI (LV Eccentricity Index)",
        view: "Derived Index",
        description: "Quantifies septal flattening (D-shape) caused by right ventricular volume or pressure overload.",
        group: "echo", method: "Calculated as: Perpendicular LVIDd₂ / Standard LVIDd. An index > 1.2 indicates significant geometric distortion.",
        imgPlaceholder: "/images/lvei-reference.jpg",
category: "Right Heart",
        difficulty: 3
    },
cvcAo: {
        audience: ["vet"], title: "CVC:Ao Ratio (Caudal Vena Cava to Aorta)",
        view: "Derived Index",
        ...
        group: "echo", method: "Calculated dynamically as: CVC (mm) / Ao (mm). A ratio > 1.3 combined with less than a 10% collapse during the respiratory cycle strongly suggests right heart failure.",
...
category: "Right Heart",
    ...
    cvcCollapse: {
        audience: ["vet"], title: "CVC Collapsibility Index",
        ...
        group: "echo", method: "Calculated as: ((CVC max - CVC min) / CVC max) × 100. Normal dogs should show > 50% collapse during a normal inspiratory effort.",
        reference: "Darnis et al. Establishment of reference values of the caudal vena cava by fast-stroke echocardiography.",
        pmid: "15632009",
category: "Right Heart",
        difficulty: 4
    ...
    changScore: {
        audience: ["vet"], title: "Chang (2026) PH Predictive Score",
        ...
        group: "echo", method: "Calculates cumulative risk using: RV:LV dilation (0-6 pts), RVWT:LVPWd ratio (0-2 pts), RA:LA ratio (0-6 pts), PA:Ao ratio (0-6 pts), IVS flattening severity (0-4 pts), and RVOT mid-systolic notching (0-1 pt). Scores ≥ 4 predict pTRV ≥ 3.4 m/s; Scores ≥ 9 predict pTRV ≥ 4.3 m/s.",
...
ivsFlattening: {
        audience: ["vet"], title: "Interventricular Septal (IVS) Flattening",
        view: "Right Parasternal Short Axis",
        ...
        group: "echo", method: "Evaluated subjectively or objectively via the Eccentricity Index (LVEI). Graded as Normal (circular), Subtle-Mild (deviated but not completely flat), or Moderate-Severe (visibly flattened or convex into the LV chamber).",
        reference: "Chang et al. (2026) Development and evaluation of a composite echocardiographic score for predicting pulmonary hypertension severity in dogs.",
        pmid: "41742574",
...
mine1: {
    audience: ["vet"], title: "MINE Score (Original 4-Parameter)",
    category: "Calculations",
    difficulty: 3,
...
acvimMmvd: {
    ...
    view: "Right Parasternal Short Axis",
    group: "echo", method: "To classify a preclinical patient as Stage B2 (warranting the initiation of pimobendan), there must be a murmur ≥3/6 and echocardiographic cardiomegaly defined strictly as an LA:Ao ≥ 1.6 AND an LVIDdn ≥ 1.7.",
